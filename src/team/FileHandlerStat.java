...
public class FileHandlerStat
{
     ...
     *
     * @param persons.txt String the name of the file (that is located in the project folder).
     ...
     */
    public static ArrayList<String> load(String persons)
    {
        Scanner file_scanner = null;
        ArrayList<String> stringArray = new ArrayList<String>();

        try {
            file_scanner = new Scanner(new File(persons));  //Connection to the file using the Scanner object
